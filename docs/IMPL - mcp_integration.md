...
class MCPServer {
  ...
  constructor(private indexer: IndexerService, private queryEngine: QueryEngine) {
...
const INDEX_TOOL: Tool = {
  ...
  inputSchema: {
    ...
    properties: {
      path: {
        type: "string",
        description: "Directory path to index (optional, defaults to current working directory)"
      },
      force: {
        type: "boolean",
        default: false,
...
const STATUS_TOOL: Tool = {
  ...
  inputSchema: {
    ...
    properties: {
      path: {
        type: "string",
        description: "Project path to check (optional, defaults to current directory)"
      }
    }
  }
};
